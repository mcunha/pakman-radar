...
| **[phnthnhnm/Scoop](directory/phnthnhnm+Scoop.md)** | 📈 +31 | 🏆 #212 | 📦 19 | ⭐ 1.0 | 🔄 100% |
| **[Spiraster/scoop-bucket](directory/Spiraster+scoop-bucket.md)** | 📈 +16 | 🏆 #124 | 📦 41 | ⭐ 1.0 | 🔄 93% |
...
* **Pipeline Times (Last Run)**:
  * 🔍 Discovery: 2.55s
  * 📥 Update: 19.56s
* **Cumulative Compute Time**: 795.5 minutes
