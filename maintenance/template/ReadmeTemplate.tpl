...
### [{{repo.full_name}}]({{repo.html_url}}) (Score: {{repo.score}}){% if repo.is_scoop_official %} 👑 Official Scoop Bucket{% endif %}{% if repo.is_shovel_official %} 👑 Official Shovel Bucket{% endif %}
